...
One of the biggest challenges was combining both extracted data, however, teamwork made the dream work and managed to combine data.
...
```{r}
setwd("C:/Users/Alex/Documents/STA9750-2024-FALL")
```
